...
const AuditQueueItem: React.FC<AuditQueueItemProps> = ({
  ...
  return (
    <div 
      className={`p-4 mb-3 rounded-lg border transition-all duration-200 cursor-pointer ${
        isSelected 
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className={`px-2 py-1 text-xs rounded-full ${getConfidenceBg(audit.confidence)} ${getConfidenceColor(audit.confidence)}`}>
