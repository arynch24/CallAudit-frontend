...
const mockDashboardData: DashboardData = {
    stats: [
        ...
        { value: 34, label: 'Total audited calls', icon: Users },
        { value: 66, label: 'Pending audits', icon: ClipboardList },
        { value: 10, label: 'Flagged audit', icon: Flag }
    ],
    flaggedCallsStats: {
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
                            ...
                            <WeeklyAuditChart
                                data={dashboardData.weeklyAuditData}
